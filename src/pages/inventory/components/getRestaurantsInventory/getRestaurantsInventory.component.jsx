...
import './getRestaurantsInventory.styles.scss'
            ...
            {restaurantInventory && restaurantInventory.map((restaurant, index) => {
              return (
                <tr key={restaurant.id}>
                  ...
                  <td><button className='btn btn-dark btn-sm' type='button' onClick={() => this.handleDelete(restaurant.id)}>Delete</button></td>
                </tr>
              )
            })}
          </tbody>
